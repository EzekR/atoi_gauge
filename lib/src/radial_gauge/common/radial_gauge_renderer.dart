          ...
          for (num j = 0; j < gauge.axes[i].pointers.length; j++) {
            ...
            if (_pointer.enableDragging && _pointer._isDragStarted) {
              final Rect _rect = Rect.fromLTRB(
                  _pointer._axis._axisRect.left + _pointer._axis._axisCenter.dx,
                  _pointer._axis._axisRect.top + _pointer._axis._axisCenter.dy,
                  _pointer._axis._axisRect.right +
                      _pointer._axis._axisCenter.dx,
                  _pointer._axis._axisRect.bottom +
                      _pointer._axis._axisCenter.dy);
              ...
              /// Checks whether the tapped position is available inside the rect of needle or marker pointer
              ...
              if (_pointer is RangePointer) {
                ...
                final Rect _pathRect = Rect.fromLTRB(
                    _rangePointer._arcPath.getBounds().left +
                        _axis._axisCenter.dx -
                        5,
                    _rangePointer._arcPath.getBounds().top +
                        _axis._axisCenter.dy -
                        5,
                ...
                // Checks whether the tapped position is present inside the range pointer path
