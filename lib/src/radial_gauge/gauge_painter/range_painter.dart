...
class _RangePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Disables the load time animation once the end value of the range is reached
  ...
  Paint _getRangePaint(bool _isFill, Rect _rect, double _strokeWidth) {
    ...
    final Paint paint = Paint()
      ...
      ..color = _range.color ?? _gauge._radialGaugeState._gaugeTheme.rangeColor;
  ...
  List<double> _getGradientOffset() {
    if (_range.gradient.stops != null && _range.gradient.stops.isNotEmpty) {
      ...
      // Calculates the gradient stop values based on the number of provided color
  ...
  void _renderRangeText(Canvas canvas) {
    ...
    final Color _color = _range.color != null
        ? _range.color
