...
class _RangePointerPainter extends CustomPainter {
  ...
  void _updateAnimation(double _sweepRadian) {
    ...
    // Disables the load time animation of pointers once its reached the end value
  ...
  Paint _getPointerPaint(Rect _rect) {
    final Paint _paint = Paint()
      ..color = _rangePointer.color ??
          _gauge._radialGaugeState._gaugeTheme.rangePointerColor
