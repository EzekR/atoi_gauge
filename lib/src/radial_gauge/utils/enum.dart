...
enum GaugeAlignment {
  /// GaugeAlignment.near aligns the gauge element to near either the horizontal or vertical.
  near,

  /// GaugeAlignment.center aligns the gauge element to center either the horizontal or vertical.
  center,

  /// GaugeAlignment.far aligns the gauge element to far either the horizontal or vertical.
  far
}
