...
/// such as a circle, text, image, triangle, inverted triangle, square, or diamond.
///
/// ```dart
...
class MarkerPointer extends GaugePointer {
  ...
  ///
  /// The arguments [value], [markerOffset], must not be null and [animationDuration], [markerWidth],
  /// [markerHeight], [borderWidth] must be non-negative.
  ///
  MarkerPointer(
      {double value = 0,
      bool enableDragging,
  ...
  /// if [offsetUnit] is [GaugeSizeUnit.factor], value will be given from 0 to 1. Here pointer placing position is calculated by [markerOffset] * axis radius value.
  ///
  /// Example: [markerOffset] value is 0.2 and axis radius is 100, pointer is moving 20(0.2 * 100) logical pixels from axis outer radius.
  /// if [offsetUnit] is [GaugeSizeUnit.logicalPixel], defined value distance pointer will move from the outer radius axis.
  ///
  ...
  ///
  /// [borderColor] is applicable for [MarkerType.circle], [MarkerType.diamond], [MarkerType.invertedTriangle],
  ...
  ///
  /// [borderWidth] is applicable for [MarkerType.circle], [MarkerType.diamond], [MarkerType.invertedTriangle],
  /// [MarkerType.triangle] and [MarkerType.rectangle].
  ///
  /// Defaults to 0
  ///
...
// ignore: prefer_void_to_null
  ...
  void drawPointer(Canvas canvas, double animationValue, Offset startPosition,
    ...
    final Paint paint = Paint()
      ..color = color ?? _axis._gauge._radialGaugeState._gaugeTheme.markerColor
    ...
    if (borderWidth != null && borderWidth > 0) {
      _borderPaint = Paint()
        ..color = borderColor ??
            _axis._gauge._radialGaugeState._gaugeTheme.markerBorderColor
    ...
    final TextSpan span = TextSpan(
        ...
        style: TextStyle(
            color: textStyle.color ??
                _axis._gauge._radialGaugeState._gaugeTheme.axisLabelColor,
